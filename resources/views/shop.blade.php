...
{{--                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>--}}
                        ...
                        <ul>
                            <li><b>Availability</b> <span>{{ $product->is_avail ? 'In Stock' : 'Out of Stock' }}</span></li>
                            <li><b>Shipping</b> <span>01 day shipping. <samp>{{ $product->is_free_shipping ? 'Free pickup today' : '' }}</samp></span></li>
